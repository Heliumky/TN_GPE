...
if __name__ == '__main__':    
    ...
    psi = get_init_other_state (N, x1, x2, maxdim, "GD2_mps_step_7000_input.pkl")
    ...
    with open('tci_initial_src.pkl', 'wb') as f:
        pickle.dump(fit, f)
    print(psi[0].shape)
    psi, enss, ts = imag_time_evol (1, H0, psi, g, dt, 1, maxdim, 40, cutoff_mps, cutoff_mps2, krylovDim)
