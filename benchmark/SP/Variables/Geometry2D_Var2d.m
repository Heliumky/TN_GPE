...
Geometry2D.dx = (xmax-xmin)/(Nx); % Spatial step along x
Geometry2D.dy = (ymax-ymin)/(Ny); % Spatial step along y
Geometry2D.Lx = xmax-xmin-Geometry2D.dx; % Size of the domain in the x direction
Geometry2D.Ly = ymax-ymin-Geometry2D.dy; % Size of the domain in the y direction
[Geometry2D.X,Geometry2D.Y] = meshgrid(xmin:Geometry2D.dx:xmax-Geometry2D.dx,ymin:Geometry2D.dy:ymax-Geometry2D.dy); % Coordinates of the points in the x,y,z direction
