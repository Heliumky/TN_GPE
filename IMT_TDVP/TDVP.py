...
if __name__ == '__main__':    
    ...
    with open('tci_initial.pkl', 'wb') as f:
        pickle.dump(psi, f)
    psi_TDVP, ens_TDVP, ts0 = imag_time_evol (step_iter, H0, psi, g, dt, steps=steps, maxdim=maxdim, maxdim_psi2=maxdim_psi2, cutoff_mps=cutoff_mps, cutoff_mps2=cutoff_mps2, krylovDim=krylovDim)
