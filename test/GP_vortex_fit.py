...
if __name__ == '__main__':    
    ...
    #psi = get_init_other_state (N, x1, x2, maxdim, "61v_mid.pkl")
    psi = get_init_other_state (N, x1, x2, maxdim, "1v.pkl")
    #psi = get_init_other_state (N, x1, x2, maxdim, "GD2_mps_step_100.pkl")
    ...
    # tdvp always gives the good basis to do variational gradient.
